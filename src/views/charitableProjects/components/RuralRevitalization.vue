    ...
    <div class="background">
      <div class="banner">
        <div class="title-content">
          ...
          <div class="subtitle">产业振兴 科技振兴<br/>人才振兴 巩固脱贫攻坚</div>
        </div>
      </div>
      <div class="projects">
        <div class="project-list">
          <router-link to="" class="project-item">
            ...
            <div class="description">阿里巴巴乡村振兴特派员</div>
          </router-link>
          <router-link to="" class="project-item">
            <img src="../../../assets/background/test.png" alt="">
          ...
          <router-link to="" class="project-item">
            <img src="../../../assets/background/test.png" alt="">
            <div class="description">数字人才培训</div>
          </router-link>
          <router-link to="" class="project-item">
            <img src="../../../assets/background/test.png" alt="">
            <div class="description">阿里巴巴乡村振兴技术官</div>
          </router-link>
          <router-link to="" class="project-item">
            <img src="../../../assets/background/test.png" alt="">
