<template>
  <div class="background-container">
    <div class="content-box">
      <h1 class="title">让教育之光照亮贫困山区（奋斗百年路 启航新征程·脱贫攻坚答卷）</h1>
      <p class="meta-info">2021年02月22日</p>
      ...
      <p class="source-link">
        <a href="http://paper.people.com.cn/rmrb/html/2021-02/22/nw.D110000renmrb_20210222_2-10.htm" target="_blank">查看原文</a>
      </p>
      <!-- 添加返回按钮 -->
